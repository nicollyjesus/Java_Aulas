...
| ------- | ---------------------- | ------------------------------------------------------------ | ----------------------------------------------------- |
| Aula 01 | Introdução ao Java     | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/helloworld1) | Primeiros passos, estrutura básica e saída de dados   |
| Aula 02 | Variáveis e Operadores | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/operadores) | Variáveis, constantes, `Scanner`, operadores diversos |
| Aula 03 | Condicionais e Lógicos | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/condicionais) | `if/else`, `switch`, operadores relacionais e lógicos |
| Aula 04 | Laços de Repetição     | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/lacosDeRepeticao) | Estruturas `for`, `while` e `do-while`                |
| Aula 05 | Arrays                 | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/arrays) | Vetores e matrizes                                    |
| Aula 06 | Collections (Parte 1)  | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/colections) | Trabalhando com `ArrayList` e `Set`                   |
| Aula 07 | Collections (Parte 2)  | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/colections) | Uso de `Queue` e `Stack`                              |
| Aula 08 | Métodos                | [Abrir](https://github.com/nicollyjesus/Java_Aulas/tree/main/vetores) | Criação de métodos com e sem retorno                  |
