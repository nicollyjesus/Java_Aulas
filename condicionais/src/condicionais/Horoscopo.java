...
public class Horoscopo { //Declara a classe principal chamada Notas.

	public static void main(String[] args) { ////Método principal onde o programa começa.

		Scanner scanner = new Scanner (System.in); //Declarando a classe Scanner, para o usuário poder digitar o número
		...
		System.out.println("            12  -  Sargitário          ");
		System.out.println("                                       ");
		System.out.println("=======================================");
